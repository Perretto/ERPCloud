...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        deleteItem: function(item) {
            ...
            //if(this.confirmDeleting && !window.confirmGrid(getOrApply(this.deleteConfirm, this, $row.data(JSGRID_ROW_DATA_KEY)), function ($row){ _deleteRow($row) }, $row))
            //    return;
            var thi = this;
            swal({
                title: getOrApply(this.deleteConfirm, this, $row.data(JSGRID_ROW_DATA_KEY)),
                text: "",
                type: "warning",
