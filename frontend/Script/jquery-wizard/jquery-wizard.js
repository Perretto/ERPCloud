        ...
        templates: {
            buttons: function () {
                ...
                return '<div class="wizard-buttons">' +
                    '<a class="wizard-back" href="#' + this.id + '" data-wizard="back" role="button">' + options.buttonLabels.back +

'</a>' +
                    '<a class="wizard-next" href="#' + this.id + '" data-wizard="next" role="button">' + options.buttonLabels.next +

'</a>' +
                    '<a class="wizard-finish" href="#' + this.id + '" data-wizard="finish" role="button">' + options.buttonLabels.finish +
...
'</a>' +
    ...
    $.extend(Step.prototype, {
        ...
        show: function (callback) {
            ...
            //Agora o plugin trabalha por abas, ent�o quando for remover o pane.active, devemos remover apenas o da aba.
            var formID = this.$element[0].getAttribute("data-formid");
            $("div[data-formid='" + formID + "']").removeClass(classes.pane.active);

            $("#" + this.$pane.selector).addClass(classes.pane.active);
    ...
    $.extend(Wizard.prototype, {
        ...
        goTo: function (index, callback) {
            ...
            if (index > this._current) {
                ...
                var containerid = $(current.$element[0]).attr("containerid");
